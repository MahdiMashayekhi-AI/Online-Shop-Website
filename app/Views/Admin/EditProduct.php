<main class="flex-1 overflow-y-auto">
    <header class="bg-white shadow-sm sticky top-0 z-10">
        <div class="px-6 py-4">
            <div class="flex justify-between items-center flex-wrap gap-4">
                <div>
                    <h2 class="text-xl md:text-2xl font-bold text-gray-800">ویرایش محصول</h2>
                    <p class="text-gray-500 text-sm mt-1">اطلاعات مورد نیاز رو ویرایش کنید</p>
                </div>
    ...
    <div class="p-6">
        ...
        <form id="addProductForm" method="POST" action="/admin/update-product" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="price" id="price" required
                                    placeholder="مثال: 25990000" value="<?= $product['price'] ?>"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="mainImagePreview" class="mt-3">
                                <div class="image-preview">
                                    <img id="mainPreviewImg" src="../<?= htmlspecialchars($product['main_image']) ?>" alt="پیش‌نمایش" class="w-32 h-32 object-cover rounded-lg">
